...
//
//        ScanlineController controller = new ScanlineController(mock(Clock.class), display, backgroundFifo, new PixelCombinator(), new PpuRegisters(), mock(PixelFetcher.class));
//
...
//        ScanlineController controller = new ScanlineController(clock, display, backgroundFifo, new PixelCombinator(), new PpuRegisters(), mock(PixelFetcher.class));
//
//        controller.renderScanline(4);
//
