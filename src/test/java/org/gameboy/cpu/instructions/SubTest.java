...
class SubTest {
    ...
    void givenByteRegisterAndValues_whenSub_thenResultIsCorrect(int a, R8 r8, int b) {
    ...
    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenSub_thenFlagsAreCorrect(int a, R8 r8, int b) {
        CpuStructure cpuStructure = new CpuStructureBuilder()
                .withA(a)
                .build();
        OperationTargetAccessor accessor = OperationTargetAccessor.from(cpuStructure);
    ...
    void givenTwoBytes_whenSubIndirectHl_thenResultIsCorrect() {
        ...
        Sub.sub_r8(indirect_hl).execute(cpuStructure);
