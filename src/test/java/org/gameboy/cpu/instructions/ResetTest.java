...
class ResetTest {
    ...
    void givenByteRegisterWithAllBitsSet_whenResetBit0_thenBit0ClearedAndValueCorrect(ByteRegister r8) {
    ...
    @ParameterizedTest
    @EnumSource(ByteRegister.class)
    void givenByteRegisterWithAllBitsSet_whenResetBit7_thenBit7ClearedAndValueCorrect(ByteRegister r8) {
        CpuStructure cpuStructure = new CpuStructureBuilder()
    ...
    void givenByteRegisterAndBitIndex_whenReset_thenBitClearedAndFlagsUnchanged(ThreeBitValue threeBitIndex, int bitIndex) {
        ...
        Reset.res_b_r8(threeBitIndex, ByteRegister.A).execute(cpuStructure);
