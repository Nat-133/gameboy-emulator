...
class AddWithCarryTest {
    static Stream<Arguments> getR8ValuePairs() {
        return Stream.of(
                ...
                Arguments.of(0x08, l, 0x07)
        );
    }

    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenAdcWithNoCarry_thenResultIsCorrect(int a, R8 r8, int b){
    ...
    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenAdcWithNoCarry_thenFlagsAreCorrect(int a, R8 r8, int b){
        CpuStructure cpuStructure = new CpuStructureBuilder()
                .withA(a)
                .build();
        OperationTargetAccessor accessor = OperationTargetAccessor.from(cpuStructure);
    ...
    void givenTwoBytes_whenAdcIndirectHlWithNoCarry_thenResultIsCorrect(){
        ...
        AddWithCarry.adc_a_r8(indirect_hl).execute(cpuStructure);
    ...
    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenAdcWithCarry_thenResultIsCorrect(int a, R8 r8, int b){
        CpuStructure cpuStructure = new CpuStructureBuilder()
                .withA(a)
    ...
    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenAdcWithCarry_thenFlagsAreCorrect(int a, R8 r8, int b){
        CpuStructure cpuStructure = new CpuStructureBuilder()
                .withA(a)
                .withExclusivelySetFlags(Flag.C)
                .build();
