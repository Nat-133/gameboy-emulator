...
class CompareTest {
    ...
    void givenByteRegisterAndValues_whenCompare_thenResultIsCorrect(int a, R8 r8, int b) {
    ...
    @ParameterizedTest
    @MethodSource("getR8ValuePairs")
    void givenByteRegisterAndValues_whenCompare_thenFlagsAreCorrect(int a, R8 r8, int b) {
        CpuStructure cpuStructure = new CpuStructureBuilder()
                .withA(a)
                .build();
        OperationTargetAccessor accessor = OperationTargetAccessor.from(cpuStructure);
    ...
    void givenTwoBytes_whenCompareIndirectHl_thenFlagsAreCorrect() {
        ...
        Compare.cp_r8(indirect_hl).execute(cpuStructure);
