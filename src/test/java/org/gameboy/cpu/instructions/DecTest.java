...
class DecTest {
    ...
    void givenByteRegisterWithZeroValue_whenDec_thenRegisterUpdatedCorrectly(Target.R8 register) {
    ...
    void givenByteRegisterWithZeroValue_whenDec_thenRegisterUpdatedCorrectly(Target.R16 register) {
        CpuStructure cpuStructure = new CpuStructureBuilder().build();
        OperationTargetAccessor accessor = OperationTargetAccessor.from(cpuStructure);
    ...
    void givenByte_whenDec_thenFlagsCorrect(byte value, List<FlagValue> expectedFlags) {
        ...
        Dec.dec_r8(Target.a).execute(cpuStructure);
    ...
    @ParameterizedTest
    @MethodSource("getAllR16")
    void givenShort_whenDec_thenNoFlags(Target.R16 register) {
        CpuStructure cpuStructure = new CpuStructureBuilder().build();
