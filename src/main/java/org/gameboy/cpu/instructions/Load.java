...
public interface Load extends Instruction {
    static Load ld_r8_r8(Target.R8 destination, Target.R8 source) {
        return BasicLoad.ld_r8_r8(destination, source);
    }

    static Load ld_r8_imm8(Target.R8 destination) {
    ...
    static Load ld_r16_imm16(Target.R16 register) {
        return BasicLoad.ld_r16_imm16(register);
    }

    static Load ld_A_mem16indirect(Target.Mem16 indirectSource) {
        return BasicLoad.ld_A_mem16indirect(indirectSource);
    }

    static Load ld_mem16indirect_A(Target.Mem16 indirectDestination) {
